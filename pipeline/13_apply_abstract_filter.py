"""
Aplica a decisão do Filter by Abstract, mantendo só os "include".

Rode: python pipeline/13_apply_abstract_filter.py
"""
...
OUT_PATH = os.path.join("data", "processed", "after_abstract_filter.csv")
...
def main() -> None:
    ...
    with open(IN_PATH, encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            if row.get("abstract_decision") == "include":
                kept.append(row)
            else:
